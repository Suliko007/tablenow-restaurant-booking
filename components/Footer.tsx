    ...
    <footer className="bg-gray-800 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">TableNow</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/restaurants" className="text-gray-300 hover:text-white">Restaurants</Link>
              </li>
              <li>
                <Link href="#" className="text-gray-300 hover:text-white">Monthly Deals</Link>
              </li>
              <li>
                <Link href="#" className="text-gray-300 hover:text-white">Private Dining</Link>
              </li>
              <li>
                <Link href="#" className="text-gray-300 hover:text-white">Top Rated</Link>
              </li>
            </ul>
          </div>
          
          <div>
            <h3 className="text-lg font-semibold mb-4">TableNow</h3>
            <ul className="space-y-2">
              <li>
              ...
              <li>
                <Link href="#" className="text-gray-300 hover:text-white">Press</Link>
              </li>
            </ul>
          </div>
